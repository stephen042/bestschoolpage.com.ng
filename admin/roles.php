                ...
                <div>
                  <section>
					...
					<div class="form-group clearfix">
                      ...
                      <div class="col-lg-10">
                        <input type="number" class="form-control required" id="usertype" name="usertype" value="<?php echo $_POST['usertype']; ?>">
                      </div>
                    </div>
                ...
                <div>
                  <section>
					...
					<div class="form-group clearfix">
                      <label class="col-lg-2 control-label " for="usertype">Usertype </label>
                      <div class="col-lg-10">
                        <input type="number" class="form-control required" id="usertype" name="usertype" value="<?php echo $aryDetail['usertype']; ?>">
                      </div>
                    </div>
