...
// 			}		
        ...
        $iLastId=$db->getVal("select id from principal_set_nextTerm order by id desc ")+1;
		$iRandomId=randomFix(15).'-'.$iLastId;        
		
		$rr =$db->getRows("select * from principal_set_nextTerm where session_id='".$_POST['session']."' and term_id='".$_POST['term_id']."' and create_by_userid='".$create_by_userid."'");
		if(count($rr) === 0){
        $aryData = array(
				...
				$flgIn = $db->insertAry("principal_set_nextTerm", $aryData);		
				
				$_SESSION['success']="Save successfully.";
		}else{
				$_SESSION['success']="Record already exist.";
		}
...
elseif(isset($_POST['edit_next_term'])) 
{
		...
		$aryData = array(
			...
			$flgIn2 = $db->updateAry("principal_set_nextTerm", $aryData, "where randomid='".$_GET['randomid']."'");
...
{
	$flgIn1 = $db->delete("principal_set_nextTerm", "where randomid='".$_GET['randomid']."'");
          ...
          <div class="col-md-12"> 
            ...
            <div class="card">
              ...
              <div class="tab-content">
				...
				// 		$iupdatedetails = $db->getRow("select * from  principal_set_nextTerm where create_by_userid='".$create_by_userid."'"); 
						
						
						$NewcrearyLisCredtet=$db->getRows("select * from principal_set_nextTerm where create_by_userid='".$create_by_userid."' order by id desc");
