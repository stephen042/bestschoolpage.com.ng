...
<div class="container">
 ...
 ?>
	...
	<img src="../uploads/<?php echo $iupdatedetails['logo']; ?>">
	...
	<div class="hh">
	<div class="row">
	<div class="col-md-5 ur pull-left">
	<span>Username</span>
	</div>
	<div id="username1" style="display:block;"  class="col-md-7 ar pull-right">
	<span><?php echo $iupdatedetails['username'];?>  </span>
	</div>
	<div id="username2" style="display:none;"  class="col-md-7 ar pull-right">
	<span>  <input type="text" name="username" value="<?php echo $iupdatedetails['username'];?>" ></span>
	</div>
	</div>
	<div class="row">
	<div class="col-md-5 ur pull-left">
	...
	<div id="email1" style="display:block;"  class="col-md-7 ar pull-right">
	<span><?php echo $iupdatedetails['email'];?> </span>
	</div>
	<div id="email2" style="display:none;"  class="col-md-7 ar pull-right">
	<span> <input type="email" name="email" value="<?php echo $iupdatedetails['email'];?>" > </span>
	</div>
	</div>
	<div class="row">
	<div class="col-md-5 ur pull-left">
	...
	<div id="contact1" style="display:block;" class="col-md-7 ar pull-right">
	<span><?php echo $iupdatedetails['contact_no'];?> </span>
	</div>
	<div id="contact2" style="display:none;"  class="col-md-7 ar pull-right">
	<span><input type="text" name="contact_no" value="<?php echo $iupdatedetails['contact_no'];?>" > </span>
	</div>
	</div>
	...
	<div class="col-md-7 ar pull-right">
	<span><?php echo $iupdatedetails['last_login'];?> </span>
	</div>
	</div>
	...
	<div class="col-md-7 ar pull-right">
	<span><?php echo date('Y-m-d',strtotime( $iupdatedetails['create_at']));?> </span>
	</div>
	</div>
	<div class="row sss">
	<div class="col-md-6">
	<button type="button" class="btn-flat" data-toggle="modal" data-target="#myModal">
	<i class="fa fa-shield" aria-hidden="true"></i><span>Change Password</span></button>
	</div>
	<div class="col-md-6"> 
	<button type="submit" name="update" id="updatebtn" style="display:none;"  class="btn"><i class="fa fa-history" aria-hidden="true"></i>
...
<div class="row"><div class="s12 m12 l12 col">
<div class="input-field">
<input type="password" class="gwt-TextBox" id="old_password"  placeholder="Enter old password">
<label for="gwt-uid-2" class="active"></label><span aria-hidden="true" class="material-label" style="display: none;"></span>
</div>
</div>
</div>
<div class="row"><div class="s12 m12 l12 col"><div class="input-field">
<input type="password" class="gwt-TextBox" id="new_password"  placeholder="Enter password" >
<label for="gwt-uid-3"></label><span aria-hidden="true" class="material-label" style="display: none;">
</span>
</div>
</div>
</div>
...
<label for="gwt-uid-4"></label><span aria-hidden="true" class="material-label" style="display: none;"></span>
</div></div></div>

</div>
<div class="modal-footer">
<button type="button" class="btn-flat teal-text" onclick="cnfrmpswd();" style="cursor: pointer;">
