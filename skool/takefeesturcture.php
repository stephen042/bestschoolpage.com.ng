								...
								<div class="col-md-12">
									...
									<div class="card">
										<ul class="nav nav-tabs" role="tablist">
											<li role="presentation" class="<?php if ($_GET['action'] == '' || $_GET['action'] == 'manage_trait') {
																				echo "active";
																			} ?>">
												<a href="<?php echo $Filename; ?>?action=manage_trait"> <i class="fa fa-exclamation-circle" aria-hidden="true"></i> <span>Fee Structure</span> </a>
											</li>
										</ul>
													...
													<form action="" method="POST" enctype="multipart/form-data">
														<div class="row">
															...
															<div class="col-md-10 col-xs-12">
																...
																<div class="form-group clearfix">
																	<label class="col-lg-2 control-label " for="userName">Amount</label>
																	<div class="col-lg-10">
																		<input type="text" class="form-control required" id="amount" name="amount" value="<?php echo $_POST['amount']; ?>">
																	</div>
																</div>
																		...
																		?>
																			<form action="" method="POST">
																				<tr>
																					...
																					<td>
																						<?php if ($_GET['randomid'] == $iList['randomid']) { ?>
																							<input type="text" name="amount" value="<?php echo $iList['amount']; ?>" class="form-control">
																						<?php } else {
																							echo $iList['amount'];
																						} ?>
																					</td>
