              ...
              <div class="col-md-12"> 
                ...
                <div class="card">
                  <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"> <a href="#settings" aria-controls="settingss" role="tab"  data-toggle="tab" > <i class="fa fa-book" aria-hidden="true"></i>  <span>ASSIGN CLASS TEACHER</span> </a> </li>
                    <li role="presentation"> <a href="#removeclass_teacher" aria-controls="removeclass_teacher" role="tab" data-toggle="tab"> <i class="fa fa-book" aria-hidden="true"></i> <span>REMOVE CLASS TEACHER</span> </a> </li>
                  </ul>
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <button type="submit" name="assignCT"
                                                                    class="btn btn-primary pull-right"><span>Assign Selected Staff</span> </button>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-12">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><input type="checkbox" name="staff_id[]"
                                      ...
                                      <?php echo $iList['first_name'] . ' ' . $iList['last_name']; ?></td>
                        ...
                        <div class="row">
                          <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                              <?php
                                                        $i = 0;
                                                        $aryList = $db->getRows("select * from class_teacher where create_by_userid='".$create_by_userid."'");
                              ...
                              <tr>
                                ...
                                <td><a href="javascript:del('<?php echo $FileName; ?>?action=classdelete&id=<?php echo $iList['id']; ?>')"><i
                                                                                class="fa fa-times"
