...
if(isset($_POST['submitcomment']))
	...
	$aryData = array(
        ...
        $flgIn2 = $db->insertAry("clas_teacher_make_comment", $aryData);
	} else	{
	 ...
	 $aryData = array(
        ...
        $flgIn2 = $db->updateAry("clas_teacher_make_comment", $aryData,"where id = '".$_POST['primaryid'][$key]."'");
                ...
                <div class="zasw1">
                    ...
                    <table  class="table table-striped table-bordered tablthisresponsive">
                        ...
                        <tr>
                                ...
                                <td id="<?php echo $a; ?>"></td>
                                <td><?php	
								$commentDetails=$db->getRow("select * from clas_teacher_make_comment  where student_id='".$aryStudent['id']."' and create_by_userid='".$create_by_userid."'");
                                 ?>
                                    ...
                                    <input type="hidden" name="primaryid[]" value="<?php echo $commentDetails['id']; ?>" >
                  ...
                  <table><tr><td><input type="submit" class="btn btn-primary" name="submitcomment" style="color:#fff; padding:10px 30px;" ></td></tr></table>
                 </form>
                  </div>
                      </div>
                <?php
